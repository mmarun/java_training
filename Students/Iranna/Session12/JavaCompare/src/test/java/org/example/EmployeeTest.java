...
public class EmployeeTest {
    ...
    @Before
    public void setUp() {
        employeeTest =new Employee("Akash","M",110,2,27000);
    ...
    {
        Employee emp=new Employee("Akash","M",110,2,27000);
        Assert.assertTrue(emp.equals(employeeTest));
    }
    @Test
    public void negativeTestEmployee()
    {
        Employee emp=new Employee("Sumedh","K",106,2,10000);
    ...
    public void firstNameTest()
    {
        ...
        Assert.assertEquals("Akash",employee2.getFirstName());
    }
    @Test
