...
public class App
{
    ...
    public static void main( String[] args )
    {
        ...
        Employee employee2=new Employee("Jhon","E",103,2,35000);
        Employee employee3=new Employee("Vikky","G",105,2,17000);
        Employee employee4=new Employee("Preetu","S",110,2,27000);
