...
public class App
{
    public static void main( String[] args ) throws IOException {
       //Created tow files namely one.txt,two.txt
        File fileName1=new File("F:\\Git-Repo\\java_training\\Students\\Sanju\\Session19\\one.txt");
        File fileName2=new File("F:\\Git-Repo\\java_training\\Students\\Sanju\\Session19\\two.txt");
        ...
        File fileName3= new File("F:\\Git-Repo\\java_training\\Students\\Sanju\\Session19\\result.txt");
